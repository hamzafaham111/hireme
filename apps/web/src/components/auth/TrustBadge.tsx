  ...
  return (
    <div className="flex flex-wrap items-center gap-4 text-sm text-slate-600 dark:text-slate-400">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-xs sm:text-sm">Verified workers</span>
      </div>
      <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-1.5">
        <svg className="size-4 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth={2}
        ...
        <span className="text-xs sm:text-sm">2,000+ users</span>
      </div>
    </div>
  )
}
